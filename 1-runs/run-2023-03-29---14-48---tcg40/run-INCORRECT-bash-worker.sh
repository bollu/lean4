...
cp $OUTFOLDER/ResetReuse.baseline.lean.in ../../src/Lean/Compiler/IR/ResetReuse.lean
cmake ../../ \
  -DCCACHE=OFF \
  -DRUNTIME_STATS=OFF
...
$TIME -v make -j10 stage2 2>&1 | tee "time-noreuse-stage2.txt"
...
cp $OUTFOLDER/ResetReuse.research.lean.in ../../src/Lean/Compiler/IR/ResetReuse.lean
...
make -j stage1
# touch $OUTFOLDER/$CSVNAME && echo "" > $OUTFOLDER/$CSVNAME
$TIME -v make -j10 stage2 2>&1 | tee "time-reuse-stage2.txt"
