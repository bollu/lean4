...
def emitLLVM (env : Environment) (modName : Name) (filepath : String) (tripleStr? : String): IO Unit := do
  ...
  | .ok _ => do
         ...
         let tripleStr := if tripleStr? == "" then (← LLVM.getDefaultTargetTriple) else tripleStr?
